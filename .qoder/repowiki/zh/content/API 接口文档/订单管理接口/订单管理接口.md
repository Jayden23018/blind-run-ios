...
OrderSchema[订单数据模型]
StatusEnum[状态枚举]
RequestSchema[请求数据模型]
end
OpenAPI --> OrderSchema
Lifecycle --> OrderSchema
UserStories --> OrderSchema
FlowState --> OrderSchema
OrderSchema --> StatusEnum
OrderSchema --> RequestSchema
```
...
CreateOrder --> RunOrderDto
GetMyOrders --> RunOrderDto
GetAvailableOrders --> RunOrderDto
GetOrderDetail --> RunOrderDto
