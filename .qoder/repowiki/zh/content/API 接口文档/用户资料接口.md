...
## 更新摘要
**所做更改**
- 更新了用户信息获取接口的实现细节和响应结构
- 完善了角色切换接口的业务逻辑和错误处理机制
- 修正了用户数据模型和角色枚举的映射关系
- 补充了紧急联系人数据模型的详细说明
- 更新了资料验证规则和必填字段要求
- 增强了错误处理和状态管理的说明
...
**图表来源**
- [BlindRunnerProfile.java:21-27](file://backend/src/main/java/com/aidrun/backend/profile/BlindRunnerProfile.java#L21-L27)
- [EmergencyContact.java:19-23](file://backend/src/main/java/com/aidrun/backend/profile/EmergencyContact.java#L19-L23)
...
- [BlindRunnerProfile.java:32-36](file://backend/src/main/java/com/aidrun/backend/profile/BlindRunnerProfile.java#L32-L36)
- [EmergencyContact.java:28-31](file://backend/src/main/java/com/aidrun/backend/profile/EmergencyContact.java#L28-L31)
