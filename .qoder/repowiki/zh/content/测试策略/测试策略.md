...
**更新** 新增志愿者接受订单守卫系统的单元测试覆盖，包括资料验证、认证状态、可用性状态等测试场景。
...
**更新** 新增志愿者守卫系统组件，包括志愿者接受订单守卫逻辑和应用状态计算属性。
...
**更新** 新增志愿者守卫系统测试，包括资料完整性验证、认证状态检查和可用性状态验证。
...
章节来源
- [blindRunTests.swift:11-38](file://blindRunTests/blindRunTests.swift#L11-L38)
- [blindRunTests.swift:97-154](file://blindRunTests/blindRunTests.swift#L97-L154)
- [VolunteerModule.swift:6-25](file://blindRun/Volunteer/VolunteerModule.swift#L6-L25)
- [AppState.swift:57-74](file://blindRun/Core/AppState.swift#L57-L74)
...
图表来源
- [VolunteerModule.swift:6-25](file://blindRun/Volunteer/VolunteerModule.swift#L6-L25)
- [blindRunTests.swift:97-128](file://blindRunTests/blindRunTests.swift#L97-L128)
...
- [VolunteerModule.swift:6-25](file://blindRun/Volunteer/VolunteerModule.swift#L6-L25)
- [AppState.swift:57-74](file://blindRun/Core/AppState.swift#L57-L74)
- [ProfileModels.swift:46-57](file://blindRun/Core/Models/ProfileModels.swift#L46-L57)
...
**更新** 新增志愿者守卫系统测试策略，确保志愿者接单前的三个必要条件得到充分验证。
...
**更新** 新增志愿者守卫系统测试数据准备指南。

章节来源
- [08-ios-architecture.md:68-82](file://docs/08-ios-architecture.md#L68-L82)
- [blindRunTests.swift:156-183](file://blindRunTests/blindRunTests.swift#L156-L183)
...
- 流水线建议
  ...
  - 性能基线：比较启动指标与关键路径耗时。
  - **新增** 志愿者守卫测试：确保志愿者接单前验证逻辑通过。
- 质量门禁
  - 覆盖率阈值：单元测试 >80%，集成测试 >70%。
  - 可访问性：零告警。
  - 启动性能：冷启动 ≤5s，热启动 ≤1s。
  - 失败即阻断：任何测试失败阻止合并。
  - **新增** 志愿者守卫测试：所有验证场景必须通过。
