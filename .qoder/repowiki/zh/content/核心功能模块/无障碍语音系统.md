...
## 更新摘要
**所做更改**
- 新增 VoiceTextField 组件章节，详细介绍强类型字段管理和组件化语音输入
- 更新语音输入服务章节，强化错误处理和键盘降级方案
- 新增强类型字段管理的无障碍支持说明
- 更新测试覆盖范围，包含新的语音输入组件和错误处理测试
...
- [SpeechService.swift:1-119](file://blindRun/blindRun/Voice/SpeechService.swift#L1-L119)
...
- **新增**：VoiceTextField 组件依赖 SpeechInputService 和 SpeechService。
- **新增**：SpeechInputService 依赖 iOS 原生 Speech 框架和 AVFoundation。
- **新增**：SpeechService 依赖 AVSpeechSynthesizer。
