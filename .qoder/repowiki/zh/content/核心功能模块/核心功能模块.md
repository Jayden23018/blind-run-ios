...
- [role-switching 规范.md](file://openspec/changes/add-aidrun-ios-spring-mvp/specs/role-switching/spec.md)
- [volunteer-order-flow 规范.md](file://openspec/changes/add-aidrun-ios-spring-mvp/specs/volunteer-order-flow/spec.md)
</cite>

## 更新摘要
**变更内容**
- 更新订单状态机规范，整合AGENTS.md中的详细状态流转规则
- 新增角色系统规范，明确双角色共享JWT和切换规则
- 完善志愿者规则，包括Mock认证、可服务开关和隐私保护
- 更新安全系统规范，明确紧急求助的强制确认机制
- 补充完整的错误码和状态约束
...
**更新** 整合AGENTS.md中的最新规范，确保功能实现符合项目最高优先级的工作合同要求。
...
- [01-产品需求文档.md:116-140](file://docs/01-产品需求文档.md#L116-L140)
...
- [08-iOS架构.md:18-32](file://docs/08-iOS架构.md#L18-L32)
...
**更新** 基于AGENTS.md的详细规范，补充了完整的状态约束和错误处理要求。

**章节来源**
- [02-MVP范围文档.md:14-115](file://docs/02-MVP范围文档.md#L14-L115)
- [03-用户故事.md:3-800](file://docs/03-用户故事.md#L3-L800)
- [07-API契约.OpenAPI.yaml:25-452](file://docs/07-API契约.OpenAPI.yaml#L25-L452)
- [09-无障碍与语音指南.md:13-143](file://docs/09-无障碍与语音指南.md#L13-L143)
- [AGENTS.md:94-181](file://AGENTS.md#L94-L181)
...
**图表来源**
- [08-iOS架构.md:33-49](file://docs/08-iOS-架构.md#L33-L49)
- [08-iOS架构.md:68-83](file://docs/08-iOS-架构.md#L68-L83)

**章节来源**
- [08-iOS架构.md:1-165](file://docs/08-iOS-架构.md#L1-L165)
...
**图表来源**
- [03-用户故事.md:5-80](file://docs/03-用户故事.md#L5-L80)
- [07-API契约.OpenAPI.yaml:25-46](file://docs/07-API契约.OpenAPI.yaml#L25-L46)
...
**更新** 基于AGENTS.md的严格规范，明确角色切换的拦截条件和错误处理。
...
**图表来源**
- [03-用户故事.md:139-158](file://docs/03-用户故事.md#L139-L158)
- [07-API契约.OpenAPI.yaml:61-81](file://docs/07-API契约.OpenAPI.yaml#L61-L81)
- [role-switching 规范.md:11-17](file://openspec/changes/add-aidrun-ios-spring-mvp/specs/role-switching/spec.md#L11-L17)
...
**更新** 补充了AGENTS.md中的详细状态约束和错误处理要求。
...
**图表来源**
- [03-用户故事.md:161-401](file://docs/03-用户故事.md#L161-L401)
- [04-用户流程与状态机.md:120-178](file://docs/04-用户流程与状态机.md#L120-L178)
- [07-API契约.OpenAPI.yaml:150-208](file://docs/07-API契约.OpenAPI.yaml#L150-L208)
...
**更新** 基于AGENTS.md的志愿者规则，补充了Mock认证、隐私保护和可服务开关的详细要求。
...
**图表来源**
- [03-用户故事.md:403-593](file://docs/03-用户故事.md#L403-L593)
- [04-用户流程与状态机.md:180-228](file://docs/04-用户流程与状态机.md#L180-L228)
- [07-API契约.OpenAPI.yaml:209-342](file://docs/07-API契约.OpenAPI.yaml#L209-L342)

**章节来源**
- [03-用户故事.md:403-593](file://docs/03-用户故事.md#L403-L593)
- [04-用户流程与状态机.md:180-228](file://docs/04-用户流程与状态机.md#L180-L228)
- [07-API契约.OpenAPI.yaml:209-342](file://docs/07-API契约.OpenAPI.yaml#L209-L342)
- [volunteer-order-flow 规范.md:3-38](file://openspec/changes/add-aidrun-ios-spring-mvp/specs/volunteer-order-flow/spec.md#L3-L38)
...
**更新** 基于AGENTS.md的详细状态机规范，补充了完整的状态约束、错误码和终端状态规则。
...
**图表来源**
- [04-用户流程与状态机.md:72-119](file://docs/04-用户流程与状态机.md#L72-L119)
- [07-API契约.OpenAPI.yaml:343-387](file://docs/07-API契约.OpenAPI.yaml#L343-L387)
...
- [07-API契约.OpenAPI.yaml:343-387](file://docs/07-API契约.OpenAPI.yaml#L343-L387)
- [order-status-lifecycle 规范.md:3-66](file://openspec/changes/add-aidrun-ios-spring-mvp/specs/order-status-lifecycle/spec.md#L3-L66)
- [AGENTS.md:108-181](file://AGENTS.md#L108-L181)
...
**更新** 基于AGENTS.md的详细规则，补充了定位权限的严格要求和演示回退机制。
...
**图表来源**
- [09-无障碍与语音指南.md:108-121](file://docs/09-无障碍与语音指南.md#L108-L121)
...
**更新** 基于AGENTS.md的详细语音播报要求，补充了完整的TTS覆盖清单和危险操作确认机制。
...
**更新** 基于AGENTS.md的严格安全规则，补充了紧急求助的强制确认机制和UI设计要求。
...
**图表来源**
- [04-用户流程与状态机.md:230-257](file://docs/04-用户流程与状态机.md#L230-L257)
...
**章节来源**
- [03-用户故事.md:403-593](file://docs/03-用户故事.md#L403-L593)
- [07-API契约.OpenAPI.yaml:412-452](file://docs/07-API契约.OpenAPI.yaml#L412-L452)
...
**更新** 基于AGENTS.md的严格依赖要求，补充了错误码处理和状态约束的依赖关系。
...
**更新** 基于AGENTS.md的性能要求，补充了错误码处理和状态约束的性能影响。
...
**更新** 基于AGENTS.md的详细错误码和状态约束，补充了完整的故障排查清单。

**章节来源**
- [00-一致性检查报告.md:15-43](file://docs/00-一致性检查报告.md#L15-L43)
- [07-API契约.OpenAPI.yaml:469-542](file://docs/07-API契约.OpenAPI.yaml#L469-L542)
...
**更新** 基于AGENTS.md的最高优先级工作合同，确保所有功能实现都符合项目源代码的真实性要求。

## 附录
- 演示脚本与验收标准详见用户故事与流程文档。
- API 约束与错误码定义见 OpenAPI 契约。
- iOS 架构与模块划分参考架构文档。
- AGENTS.md 作为项目最高优先级的工作合同，具有最高的权威性。
