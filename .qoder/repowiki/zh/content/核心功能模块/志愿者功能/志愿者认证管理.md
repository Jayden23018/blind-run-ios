...
+ updateAvailability(AppUser user, boolean isAvailable) VolunteerProfileDto
}
class VolunteerController {
- VolunteerService volunteerService
+ mockVerificationApprove(Authentication authentication) ResponseEntity
+ updateAvailability(AvailabilityRequest request, Authentication authentication) ResponseEntity
}
...
**图表来源**
- [VolunteerService.java:15-62](file://backend/src/main/java/com/aidrun/backend/volunteer/VolunteerService.java#L15-L62)
- [VolunteerController.java:15-40](file://backend/src/main/java/com/aidrun/backend/volunteer/VolunteerController.java#L15-L40)
