...
## 更新摘要
**所做更改**
- 新增 DemoRelease 构建配置章节，详细说明新增的演示版构建变体
- 更新本地配置管理章节，新增 AIDRUN_PRODUCTION_API_BASE_URL 环境变量配置
- 新增构建通道与环境配置章节，解释 Demo 和 Production 构建通道的区别
...
- [LocalConfig.xcconfig.example:16-36](file://LocalConfig.xcconfig.example#L16-L36)
...
- [project.pbxproj:566](file://blindRun.xcodeproj/project.pbxproj#L566)
...
**章节来源**
- [LocalConfig.xcconfig.example:23-36](file://LocalConfig.xcconfig.example#L23-L36)
- [AMapManager.swift:14-34](file://blindRun/Map/AMapManager.swift#L14-L34)
- [project.pbxproj:278-318](file://blindRun.xcodeproj/project.pbxproj#L278-L318)
