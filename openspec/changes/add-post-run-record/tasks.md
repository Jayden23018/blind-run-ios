...
- [ ] 1.4 Unit tests: open-enum fallback, unknown event/message skipped, nulls stay nil, request shapes, Mock behavior
...
- [ ] 3.6 Unit tests: encoding omits nil / never 0, cadence unit, anchor reuse on relaunch, altitude baseline, coordinator start/stop

## 4. Handoff and validation

- [x] 4.1 Answer `demo/docs/handoff.md` 2026-09-24「待前端确认」item 1
- [ ] 4.2 Full real-device run via `scripts/device-test-all.sh` with real pass/fail counts
