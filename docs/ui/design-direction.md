...
> 依据：[`ai-ui-design-workflow-for-swiftui-20260907.md`](../research/ai-ui-design-workflow-for-swiftui-20260907.md) §3.2。
> ⚠️ 那份报告的 **§2.4（Figma）已被 2026-09-21 订正**，见
> [`figma-mcp-bidirectional-20260921.md`](../research/figma-mcp-bidirectional-20260921.md) ——
> 「要 Xcode 27 beta」只对「在 Xcode 里用」成立，Claude Code 直连不受此限，
> 且 `code → design`（把 SwiftUI 推回 Figma）方向现在官方支持。
